...
public class ComplexPolygonTest {
    ...
    public void testComplexPolygonAutoFix() {
        ...
        assertTrue("Exterior ring should be counterclockwise after auto-fix", PolygonOrientationUtils.isCounterClockwise(polygon.getExteriorRing()));

        assertFalse("Interior ring 1 should be clockwise after auto-fix", PolygonOrientationUtils.isCounterClockwise(polygon.getInteriorRing(0)));

        assertFalse("Interior ring 2 should be clockwise after auto-fix", PolygonOrientationUtils.isCounterClockwise(polygon.getInteriorRing(1)));
    }
    ...
    public void testComplexPolygonValidation() {
        ...
        try {
            ...
            PolygonOrientationUtils.validatePolygonOrientation(Collections.singletonList(invalidExteriorRing));
    ...
    public void testPolygonWithDonutHole() {
        ...
        // Verify orientations
        assertTrue("Exterior ring should be counterclockwise", PolygonOrientationUtils.isCounterClockwise(mainPolygon.getExteriorRing()));

        assertFalse("Medium hole should be clockwise", PolygonOrientationUtils.isCounterClockwise(mainPolygon.getInteriorRing(0)));

        assertTrue("Island exterior should be counterclockwise", PolygonOrientationUtils.isCounterClockwise(islandPolygon.getExteriorRing()));
    ...
    public void testPolygonWithManyPoints() {
        ...
        assertFalse("Ring should be clockwise initially", PolygonOrientationUtils.isCounterClockwise(manyPoints));
